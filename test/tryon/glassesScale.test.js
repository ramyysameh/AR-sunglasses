...
describe('resolveGlassesScaleMultiplier', () => {
  ...
  it('defaults to 1.15 in portrait when no override is given', () => {
    expect(resolveGlassesScaleMultiplier('', true)).toBeCloseTo(1.15)
  })
  ...
  it('ignores a non-positive or non-numeric gscale', () => {
    expect(resolveGlassesScaleMultiplier('?gscale=0', true)).toBeCloseTo(1.15)
    expect(resolveGlassesScaleMultiplier('?gscale=-2', true)).toBeCloseTo(1.15)
