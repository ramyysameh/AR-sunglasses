...
| Interaction and feedback | 4/4 | [Acceptance row 4](docs/qa/polaris-ux-acceptance.md#result-table) — per-failure critical banners with retry, forced-failure test (`test/appProducts.unmap.test.js`), toasts kept supplementary. |
